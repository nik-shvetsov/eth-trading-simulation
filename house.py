...
class Household(object):
    ...
    def getBasicInfo(self):
        return ("Household id is {0}, RA: {1}, address in Ethereum blockchain:{2}".format(self.id, self.ruler.id, self.address))
    ...
    def getHomeProbStatus(self, hour):
        ...
        fun_prob = [0.92, 0.891, 0.859, 0.823, 0.784, 0.741, 0.696, 0.649, 0.6, 0.5, 0.55, 0.599, 0.646,
                    0.691, 0.734, 0.773, 0.809, 0.841, 0.87,  0.894, 0.92, 0.9, 0.9, 0.96]
...
class RulerAgent(object):
    ...
    def getLastHourProduction(self, currentHour, weather): #production for prev hour (23-0)
        rnd.seed()
    ...
    def getNextHourConsumption(self, currentHour, weather): #consumption for next hour (0-1)
